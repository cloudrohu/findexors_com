...
# =====================================================
# FIX 1: parse_fieldsets_inlines_from_tabs (MAIN CRASH FIX)
# =====================================================
def fixed_parse_fieldsets_inlines_from_tabs(self, request, obj):
    fieldsets = []
    inlines = []
    ...
    for tab in tabs:
        ...
        for item in tab_content:
            ...
            if isinstance(item, type) and issubclass(
                item, admin.options.InlineModelAdmin
            ):
...
# =====================================================
# FIX 2: get_fieldsets (KeyError FIX)
# =====================================================
def fixed_get_fieldsets(self, request, obj=None):
    if hasattr(self, "tabs"):
        return self.fieldsets or ()
    return super(
        tabbed_admin.admin.TabbedModelAdmin, self
...
# APPLY PATCHES
# =====================================================
tabbed_admin.admin.TabbedModelAdmin.parse_fieldsets_inlines_from_tabs = (
    fixed_parse_fieldsets_inlines_from_tabs
)
tabbed_admin.admin.TabbedModelAdmin.get_fieldsets = fixed_get_fieldsets
