...
def load_localities(request):
    ...
    if city_id:
        localities = Locality.objects.filter(city_id=city_id).order_by('title')
    else:
        localities = Locality.objects.none()
...
def load_sub_localities(request):
    ...
    if locality_id:
        sub_localities = Sub_Locality.objects.filter(locality_id=locality_id).order_by('title')
    else:
        sub_localities = Sub_Locality.objects.none()
