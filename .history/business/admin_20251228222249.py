...
class CompanyAdmin(AutoUserAdminMixin, admin.ModelAdmin):
    ...
    # 👇 CHANGE: JS load karne ke liye Media class
    class Media:
        js = (
            '//ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js', # jQuery
            'js/admin_dependent_dropdown.js', # Aapki custom script
        )

    list_display = (
        "id", "company_name", "category",
        "city", "locality", "sub_locality", "project", # Project added
        "contact_no", "status",
    ...
    search_fields = (
        ...
        "sub_locality__title", "project__title" # Project search
    )
