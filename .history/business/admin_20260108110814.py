# ==========================================
# 1. COMPATIBILITY FIX (Django 4.0+)
# ==========================================
...
from tabbed_admin import TabbedModelAdmin  # Third party lib
...
class CompanyAdmin(AutoUserAdminMixin, TabbedModelAdmin):
    ...
    def get_formatted_tabs(self, request, obj=None):
        ...
        Overrides library caching logic to ensure 'fieldsets' key always exists.
        """
        tabs = self.get_tabs(request, obj)
    ...
    # Fallback Fieldsets (Standard View)
    fieldsets = (
        ("🏢 Company Info", {
            "fields": (
    ...
    # Fallback Inlines (Standard View)
    inlines = [
        ImagesInline, SocialLinkInline, FaqInline, CommentInline,
        VoiceRecordingInline, VisitInline, FollowupInline, MeetingInline
    ]
