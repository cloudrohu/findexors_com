...
# ✅ SAFE monkey patch for tabbed_admin
def fixed_get_fieldsets(self, request, obj=None):
    """
    Prevent KeyError: 'fieldsets'
    Django 5 + tabbed_admin safe override
    """

    # Agar tabs defined hain → use normal Django fieldsets
    if hasattr(self, "tabs"):
        return self.fieldsets or ()

    # Default Django behavior
    return super(tabbed_admin.admin.TabbedModelAdmin, self).get_fieldsets(
        request, obj
    )


# 🔥 Monkey patch get_fieldsets
