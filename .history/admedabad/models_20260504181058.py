...
class Followup(models.Model):
    ...
    Followup_from = models.CharField(max_length=25, null=True, blank=True,choices=FOLLOWUP)
    ...
    def save(self, *args, **kwargs):
        ...
        if self.company:
            # ❗ Agar deal already close hai to override na ho
...
class Meeting(models.Model):
    ...
    Followup_from = models.CharField(max_length=25, null=True, blank=True,choices=MEETINGFROM)
