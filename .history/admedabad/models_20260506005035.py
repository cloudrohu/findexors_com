...
class AhmedabadCompany(models.Model):
    ...
    created_by = models.ForeignKey(User, related_name="ahmedabadcompany_created", on_delete=models.SET_NULL, null=True, blank=True)
    updated_by = models.ForeignKey(User, related_name="ahmedabadcompany_updated", on_delete=models.SET_NULL, null=True, blank=True)
...
class AhmedabadResponse(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        if self.pk:  # existing object
            ...
            has_meeting = hasattr(self, "meeting") and self.meeting is not None
            has_followup = hasattr(self, "followup") and self.followup is not None
...
class Followup(models.Model):
    ...
    created_by = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="ahmedabad_followup_created"   # 🔥 FIXED
    )
...
class Meeting(models.Model):
    ...
    meeting_from = models.CharField(
        max_length=25,
        null=True,
        blank=True,
        choices=MEETING_FROM_CHOICES
    )
    ...
    created_by = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="ahmedabad_meeting_created"   # UNIQUE
    )
