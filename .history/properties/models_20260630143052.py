...
from utility.models import City, Locality, Postal_Code
...
class Developer(models.Model):
    ...
    created_by = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="developer_created",
    )
    ...
    updated_by = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="developer_updated",
    )
...
class Architects(models.Model):
    ...
    created_by = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="architect_created",
    )
    ...
    updated_by = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="architect_updated",
    )
...
class ProjectContactPerson(models.Model):
    ...
    created_by = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="project_contact_created"
    )
...
class Comment(models.Model):
    ...
    created_by = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="property_comments_created",
    )
...
class Visit(models.Model):
    ...
    created_by = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="property_visit_created",
    )
...
class Followup(models.Model):
    ...
    created_by = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="property_followup_created",
    )
...
class Meeting(models.Model):
    ...
    created_by = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="property_meeting_created",
    )
