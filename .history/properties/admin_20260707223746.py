...
class ArchitectsAdmin(AutoUserAdminMixin, admin.ModelAdmin):

    change_list_template = "admin/properties/architects/change_list.html"
    ...
    def get_queryset(self, request):
        return (
            ...
            .prefetch_related(
                ...
                "visits",
                "voice_recordings",
                "project_set",   # agar architect ka project relation hai to rakho, nahi hai to hata do
            )
        )
...
class EngineerAdmin(AutoUserAdminMixin, admin.ModelAdmin):

    change_list_template = "admin/properties/engineer/change_list.html"
    ...
    def get_queryset(self, request):
        return (
            ...
            .prefetch_related(
                ...
                "visits",
                "voice_recordings",
                "project_set",   # Agar relation nahi hai to is line ko hata dena
            )
        )
