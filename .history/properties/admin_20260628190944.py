...
class ArchitectsAdmin(AutoUserAdminMixin, ImportExportModelAdmin):
    ...
    fieldsets = (
        ('Basic Information', {
            'fields':('title', 'status',  'city', 'locality', 'address','postal_code','contact_person', 'contact_no', 'email', 'web_site','featured_architect',)
        }),
...
class EngineerAdmin(AutoUserAdminMixin, ImportExportModelAdmin):
    ...
    fieldsets = (
        ('Basic Information', {
            'fields':('title', 'status', 'city', 'locality', 'address','postal_code','contact_person', 'contact_no', 'email', 'web_site','featured_engineer',)
        }),
