...
class Job(models.Model):
    ...
    industry = models.ForeignKey(
        JobIndustry, on_delete=models.SET_NULL, null=True, blank=True
    )
    ...
    salary_type = models.ForeignKey(
        SalaryType, on_delete=models.SET_NULL, null=True
    )
    ...
    working_days = models.ForeignKey(
        WorkingDaysOption, on_delete=models.SET_NULL, null=True
    )
    ...
    created_by = models.ForeignKey(
        ...
        null=True, blank=True, related_name="jobs_created"
    )
    ...
    def save(self, *args, **kwargs):
        if not self.slug and self.title:
            self.slug = slugify(
                f"{self.company.company_name}-{self.title.name}"
            )
