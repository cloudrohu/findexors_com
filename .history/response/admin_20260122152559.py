...
# =====================================================
# ✅ RESPONSE INFO MIXIN (for Inlines)
# =====================================================
...
class ResponseAdmin(AutoUserAdminMixin, admin.ModelAdmin):
    ...
    preserve_filters = True  # ✅ page/filter preserve
    ...
    def get_search_results(self, request, queryset, search_term):
        ...
        if search_term:
            ...
            # digit search (phone)
            only_digits = "".join([c for c in term if c.isdigit()])
            if only_digits:
                queryset |= self.model.objects.filter(contact_no__icontains=only_digits)
...
class MeetingAdmin(AutoUserAdminMixin, admin.ModelAdmin):
    ...
    list_display = ("mt_id", "response", "status", "meeting_date", "assigned_to", "create_at")
    ...
    def get_search_results(self, request, queryset, search_term):
        ...
        if search_term:
            ...
            only_digits = "".join([c for c in term if c.isdigit()])
            if only_digits:
                queryset |= self.model.objects.filter(response__contact_no__icontains=only_digits)
...
class FollowupAdmin(AutoUserAdminMixin, admin.ModelAdmin):
    ...
    list_display = ("fu_id", "response", "status", "followup_date", "assigned_to", "create_at")
