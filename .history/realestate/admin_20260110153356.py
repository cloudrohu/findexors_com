...
# =====================================================
# ✅ INLINES (show inside GoogleCompany)
# =====================================================
...
class FollowupAdmin(AutoUserAdminMixin, admin.ModelAdmin):
    list_display = ("id", "company", "status", "followup_date", "assigned_to", "updated_at")
    search_fields = ("company__name", "company__phone")
...
class MeetingAdmin(AutoUserAdminMixin, admin.ModelAdmin):
    list_display = ("id", "company", "status", "meeting_date", "assigned_to", "updated_at")
    search_fields = ("company__name", "company__phone")
    list_filter = ("status", "assigned_to")
    readonly_fields = ("created_at", "updated_at", "created_by", "updated_by")
