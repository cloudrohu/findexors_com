...
# =====================================================
# ✅ GOOGLE COMPANY ADMIN (IMPORT/EXPORT)
# =====================================================
...
class GoogleCompanyAdmin(ImportExportModelAdmin):
    ...
    list_display = (
        "id", "name", "phone", "address", "status", "category",
        "city", "locality", "sub_locality", "project",  "postal_code",
        "rating", "reviews", "business_status", "created_at"
    )

    search_fields = ("name", "phone", "place_id", "google_id", 'postal_code', "cid")
    list_filter = ("business_status", "country","status", 'postal_code',"state","category",
        "city", "locality", "sub_locality", "project",  PhoneFilter)
    ordering = ("-created_at",)
