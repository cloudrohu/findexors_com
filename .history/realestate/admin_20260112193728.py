...
from import_export.admin import ImportExportMixin  # ✅ Corrected Import
...
# =====================================================
# ✅ GOOGLE COMPANY ADMIN (Fixed)
# =====================================================
@admin.register(GoogleCompany)
class GoogleCompanyAdmin(ImportExportMixin, admin.ModelAdmin):
    resource_class = GoogleCompanyResource
    
    # ✅ Ab ye template load HOGA kyunki humne 'Mixin' use kiya hai
...
class CommentAdmin(AutoUserAdminMixin, admin.ModelAdmin):
    ...
    list_filter = (
        "company__status", "company__category", "company__city",
        "company__locality", "company__project",
    )
...
class MeetingAdmin(AutoUserAdminMixin, admin.ModelAdmin):
    ...
    list_filter = (
        "status", "assigned_to",
        "company__category", "company__city", "company__locality",
        "company__project",
    )
